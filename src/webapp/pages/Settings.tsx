...
import {useColorMode, Button, Label, Input, Box, Container } from 'theme-ui';
...
const Settings = () => {
    ...
    const { i18n, t } = useTranslation() // can load namespace to access more specific set of translations

    // callback function to set all defaults
    // useCallback with no dependencies array, this will keep the same function ref as we dont need to re-defined it
